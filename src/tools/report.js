...
const COLLECT = async() => {
    ...
    try{
        const api_url = import.meta.env.VITE_ENVIRONMENT === "development" ? import.meta.env.VITE_REPORT : import.meta.env.VITE_REPORT_LIVE
        ...
        if (!user_location) {
            const urls = [
                ...
                "https://ipapi.co/json/",
                "https://api.ipgeolocation.io/ipgeo?apiKey=" + import.meta.env.VITE_GEO_LOCATION
            ];
